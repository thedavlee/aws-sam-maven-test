...
```bash
david-sam-test-java-maven$ sam build
```
...
```bash
david-sam-test-java-maven$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
david-sam-test-java-maven$ sam local start-api
david-sam-test-java-maven$ curl http://localhost:3000/
```
...
```bash
david-sam-test-java-maven$ sam logs -n HelloWorldFunction --stack-name david-sam-test-java-maven --tail
```
...
```bash
david-sam-test-java-maven$ cd HelloWorldFunction
...
```bash
aws cloudformation delete-stack --stack-name david-sam-test-java-maven
```
